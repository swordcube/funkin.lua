...
function ModLoader.init()
    ...
    Engine.preSceneSwitch:connect(function(newScene)
        callOnMainScripts("onSceneSwitch", {newScene})
    end)
    Engine.preSceneInit:connect(function(newScene)
        callOnMainScripts("onSceneInit", {newScene})
    end)
    Engine.postSceneSwitch:connect(function(newScene)
        callOnMainScripts("onSceneSwitchPost", {newScene})
    end)
    Engine.onQuit:connect(function()
        callOnMainScripts("onGameQuit")
    end)
end
